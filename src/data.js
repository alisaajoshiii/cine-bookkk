...
export const cinemas = [
  {
    id: 1,
    name: "QFX Cinemas - Lavender Mall",
    location: "Lavender Mall, 4th Floor",
    facilities: ["Dolby Atmos", "Recliners", "Food Court"],
    image: "https://images.unsplash.com/photo-1517604931442-71053e3e2e3c?w=800&auto=format&fit=crop"
  },
  {
    id: 2,
    name: "Big Movies - Tulip Tower",
    location: "Tulip Tower, Center City",
    facilities: ["4K Projection", "Premium Sound", "Parking"],
...
export const offers = [
  {
    id: 1,
    title: "Couple Combo 🌸",
    description: "Get 2 Tickets + Large Popcorn + 2 Drinks at Rs. 1000",
    discount: "20% OFF",
    color: "#9b59b6"
  },
  {
    ...
    description: "Show your ID and get 15% off on morning shows.",
    discount: "15% OFF",
    color: "#ff6b81"
  },
  {
    id: 3,
    title: "Family Pack",
    description: "Buy 4 Tickets and get a free large nachos.",
